...
Model_Body_Weight <- lmer(Weight_g ~ Set -1  + Sex +Age_Weeks + (1 + Age_Weeks | Fish_ID) , data = Weight_Length_Data)
...
Model_Body_Weight2 <- lmer(Weight_g ~ Set + Sex + Age_Weeks + (1 | Fish_ID), data = Weight_Length_Data) 
...
>>>>>>> 93cf7cfc91807e23158cdfd7d21c81ee05e823ff
