...
Weight_Length_Data$Age_Weeks <- as.factor(Weight_Length_Data$Age_Weeks)
...
Model_Body_Weight <- lmer(Weight_g ~ Set + Sex + (1 | Fish_ID) + (1|Age_Weeks), data = Weight_Length_Data)
...
Model_Body_Weight2 <- lmer(Weight_g ~ Set + Sex + (1 | Fish_ID) + (1 + Age_Weeks|Set), data = Weight_Length_Data) 
