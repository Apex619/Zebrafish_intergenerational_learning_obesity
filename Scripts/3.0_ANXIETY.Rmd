...
#Calculating repeatabilities using custom made functions
rpt_latency_high(Anxiety_Control) -> Control_latency_high 
Control_latency_high 
rpt_latency_high(Anxiety_Treatment) -> Treatment_latency_high 
Treatment_latency_high
rpt_latency_high(Anxiety_Maternal) -> Maternal_latency_high
Maternal_latency_high
rpt_latency_high(Anxiety_Paternal) -> Paternal_latency_high
Paternal_latency_high
