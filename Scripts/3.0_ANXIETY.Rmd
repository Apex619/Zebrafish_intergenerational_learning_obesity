...
Anxiety_Joined$cWater_Time <- scale(Anxiety_Joined$Water_Time, scale=FALSE)
...
load("./Models/Paternal_Tot_Dist.rdata")
load("./Models/Maternal_Tot_Dist.rdata")
...
load("./Models/Maternal_low_dur.rdata")
load("./Models/Paternal_low_dur.rdata")
...
#Contrasts
control_boot <- unlist_rptr(Control_Tot_Dist) #unlisting from the control tanks
treatment_boot <- unlist_rptr(Treatment_Tot_Dist)#unlisting from treatment tanks
maternal_boot <- unlist_rptr(Maternal_Tot_Dist)#unlisting from maternal tanks
paternal_boot <- unlist_rptr(Paternal_Tot_Dist)#unlisting from paternal tanks
...
mat_tre_diff <- difference_boot(maternal_boot,treatment_boot) #calculating the difference
...
lmer_var_tot_dist <- function(){
  mod1 <- lme(tot_dist ~ Tank + Sex + scale(Water_Time, scale =FALSE), random = ~ 1| Fish_ID, data = Anxiety_Joined, na.action=na.exclude)
  mod2 <- lme(tot_dist ~ Tank + Sex+ scale(Water_Time, scale =FALSE), random = ~ 1| Fish_ID, weights = varIdent(form=~1|Tank), data = Anxiety_Joined, na.action=na.exclude)
...
# save(Maternal_low_dur, file = "./Models/Maternal_low_dur.rdata")
Maternal_low_dur
# rpt_low_dur(Anxiety_Paternal) -> Paternal_low_dur
# save(Paternal_low_dur, file = "./Models/Paternal_low_dur.rdata")
Paternal_low_dur

#Contrasts
control_boot <- unlist_rptr(Control_low_dur) #unlisting from the control tanks
treatment_boot <- unlist_rptr(Treatment_low_dur)#unlisting from treatment tanks
maternal_boot <- unlist_rptr(Maternal_low_dur)#unlisting from maternal tanks
paternal_boot <- unlist_rptr(Paternal_low_dur)#unlisting from paternal tanks
...
mat_con_diff <- difference_boot(maternal_boot,control_boot) #calculating the difference
qmc <- quantiles_diff_boot(mat_con_diff) #obtaining 95% CI
mmc <- mean(mat_con_diff) #Obtaining mean
qmc
mmc 
...
# Calculating difference in variance between short tanks and tall tanks 
Model_low_dur1 <- lme(low_dur ~ Tank + Sex +scale(Water_Time, scale =FALSE), random = ~ 1| Fish_ID, data = Anxiety_Joined, na.action=na.exclude) #mixed model without variance structure
tab_model(Model_low_dur1)
summary(Model_low_dur1)
Model_low_dur2 <- lme(low_dur ~ Tank + Sex + scale(Water_Time, scale =FALSE), random = ~ 1| Fish_ID, weights = varIdent(form=~1|Tank), data = Anxiety_Joined, na.action=na.exclude) #mixed model with variance structure varIdent
...
<!-- # Calculating difference in variance between short tanks and tall tanks  -->
<!-- Model_mid_dur1 <- lme(mid_dur ~ Tank + Sex+ scale(Water_Time, scale =FALSE), random = ~ 1| Fish_ID, data = Anxiety_Joined, na.action=na.exclude) #mixed model without variance structure -->
<!-- summary(Model_mid_dur1) -->
<!-- tab_model(Model_mid_dur1) -->
<!-- Model_mid_dur2 <- lme(mid_dur ~ Tank + Sex+ scale(Water_Time, scale =FALSE), random = ~ 1| Fish_ID, weights = varIdent(form=~1|Tank), data = Anxiety_Joined, na.action=na.exclude) #mixed model with variance structure varIdent -->
...
<!-- # Calculating difference in variance between short tanks and tall tanks  -->
<!-- Model_high_dur1 <- lme(high_dur ~ Tank + Sex+ scale(Water_Time, scale =FALSE), random = ~ 1| Fish_ID, data = Anxiety_Joined, na.action=na.exclude) #mixed model without variance structure -->
<!-- summary(Model_high_dur1) -->
<!-- tab_model(Model_high_dur1) -->
<!-- Model_high_dur2 <- lme(high_dur ~ Tank + Sex+ scale(Water_Time, scale =FALSE), random = ~ 1| Fish_ID, weights = varIdent(form=~1|Tank), data = Anxiety_Joined, na.action=na.exclude) #mixed model with variance structure varIdent -->
...
<!-- # Calculating difference in variance between short tanks and tall tanks  -->
<!-- Model_freezing_dur1 <- lme(log(freezing_dur+1) ~ Tank + Sex+ scale(Water_Time, scale =FALSE), random = ~ 1| Fish_ID, data = Anxiety_Joined, na.action=na.exclude) #mixed model without variance structure -->
<!-- summary(Model_freezing_dur1) -->
<!-- tab_model(Model_freezing_dur1) -->
<!-- Model_freezing_dur2 <- lme(log(freezing_dur+1) ~ Tank + Sex+ scale(Water_Time, scale =FALSE), random = ~ 1| Fish_ID, weights = varIdent(form=~1|Tank), data = Anxiety_Joined, na.action=na.exclude) #mixed model with variance structure varIdent -->
...
<!-- # Calculating difference in variance between short tanks and tall tanks  -->
<!-- Model_latency_high1 <- lme(latency_high ~ Tank + Sex+ scale(Water_Time, scale =FALSE), random = ~ 1| Fish_ID, data = Anxiety_Joined, na.action=na.exclude) #mixed model without variance structure -->
<!-- summary(Model_latency_high1) -->
<!-- tab_model(Model_latency_high1) -->
<!-- Model_latency_high2 <- lme(latency_high ~ Tank + Sex+ scale(Water_Time, scale =FALSE), random = ~ 1| Fish_ID, weights = varIdent(form=~1|Tank), data = Anxiety_Joined, na.action=na.exclude) #mixed model with variance structure varIdent -->
...
<!-- # Calculating difference in variance between short tanks and tall tanks  -->
<!-- Model_freq_high1 <- lme(sqrt(freq_high) ~ Tank + Sex+ scale(Water_Time, scale =FALSE), random = ~ 1| Fish_ID, data = Anxiety_Joined, na.action=na.exclude) #mixed model without variance structure -->
<!-- summary(Model_freq_high1) -->
<!-- tab_model(Model_freq_high1) -->
<!-- Model_freq_high2 <- lme(sqrt(freq_high) ~ Tank + Sex+ scale(Water_Time, scale =FALSE), random = ~ 1| Fish_ID, weights = varIdent(form=~1|Tank), data = Anxiety_Joined, na.action=na.exclude) #mixed model with variance structure varIdent -->
