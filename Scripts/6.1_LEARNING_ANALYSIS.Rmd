...
rpt_learning(Learning_Control) -> str(rpt_learning_control)
...
#Within and between individual variance for all groups


rpt_within_learning(Learning_Control) -> rpt_within_between_control
rpt_within_learning(Learning_Treatment) -> rpt_within_between_treatment
rpt_within_learning(Learning_Maternal) -> rpt_within_between_maternal
rpt_within_learning(Learning_Paternal) -> rpt_within_between_paternal
