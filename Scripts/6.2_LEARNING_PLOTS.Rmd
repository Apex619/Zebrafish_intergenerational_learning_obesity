...
Endpoint = c("Learning", "Learning", "Learning", "Learning"))
...
groups_f1 <- c("F1C", "F1T", "F1P", "F1M")

p2cs$Tank2 <- reorder(p2cs$Tank, p2cs$difference)

means <- aggregate(difference ~  Tank + Sex, p2cs, mean)
...
# geom_signif(comparisons = list(c("Within Treatment", "Paternal")), #Adding contrasts         #EDIT ONCE CONFIRMED WHICH ARE SIGNIFICANT
#               map_signif_level=TRUE, y_position = 50, annotations = "**", textsize = 4)+
# geom_signif(comparisons = list(c("Within Treatment", "Maternal")), #Adding contrasts
#               map_signif_level=TRUE, y_position = 40, annotations = "**", textsize = 4)  +
